...
export async function POST(req: Request) {
    try{ 
       ...
       const embedding = await openai.embeddings.create({
        ...
        const template = {
            role: "system",
            content: `You are an AI assistant who knows everything about Seen Apps. Use the below context to argument what you know about Seen Apps. The context will provide you with the most recent page data from Seen apps website. If the context doesn't include the information you need answer based on your existing knowledge and don't mention the source of your information or what the context does or does not include. Format responses using markdown where applicable and don't return images.
            ------------
            START CONTEXT
            ${docContext}
            END CONTEXT
